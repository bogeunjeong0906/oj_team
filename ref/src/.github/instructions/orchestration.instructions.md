...
- TAS is a separate standalone request-producing agent and follows its own TAS workflow rules instead of the internal Leader workflow.
...
- The leader should start with Researcher alone unless an active request already has approved support capacity in flight.
